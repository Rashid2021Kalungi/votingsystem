...
?>
<form action="updatecandidate.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="main">
        ...
        <div>
            <input type="text" placeholder="Enter candidate name" name="id" value="<?php echo $editData['id']??''; ?>"required>
